...
export default function AboutPage() {
  return (
    <div className="about-container">
      <h1>About Service Record Logger</h1>
      <p>
        Service Record Logger is a web-based application designed to help users and administrators manage service records efficiently.
      </p>
      <p>
